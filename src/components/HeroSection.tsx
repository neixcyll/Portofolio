        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-primary text-primary-foreground font-medium rounded-full hover:bg-primary/90 transition-all duration-300 glow-gold"
            >
              View My Work
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 border border-border text-foreground font-medium rounded-full hover:bg-secondary/50 transition-all duration-300"
            >
              Get In Touch
            </motion.a>
          </motion.div>
